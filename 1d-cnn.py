...
class KerasCNN1DClassifier(BaseEstimator, ClassifierMixin):
...
for selection_name, selection_factory in selection_methods.items():
    ...
    for k in feature_counts:
        ...
        print(f"\n{'=' * 60}")
        print(f"{selection_name} - {k} FEATURES - 1D-CNN")
        print(f"{'=' * 60}")
